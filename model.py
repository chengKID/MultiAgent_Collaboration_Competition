...
class Actor_Critic_Models():
    ...
    def __init__(self, n_agents, state_size=24, action_size=2, seed=0):
        ...
        self.critic_local = CriticModel(state_size*n_agents, action_size*n_agents, seed).to(device)
        self.critic_target = CriticModel(state_size*n_agents, action_size*n_agents, seed).to(device)