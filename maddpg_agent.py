...
class MADDPG():
    ...
    def save_agents(self):
        ...
        for i, agent in enumerate(self.agents):
            torch.save(agent.actor_local.state_dict(),  f"pth/checkpoint_actor_agent_{i}.pth")
            torch.save(agent.critic_local.state_dict(), f"pth/checkpoint_critic_agent_{i}.pth")
